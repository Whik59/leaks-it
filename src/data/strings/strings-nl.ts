export const strings = {
  ...
  redirectPopupGenderStats: "71% vrouwen 29% mannen",
  ...
  // Warning Modal
  warningModalTitle: "⚠️ Wacht! Het is GRATIS",
  warningModalMessage: "Toegang tot de leaks is 100% gratis. Je mist een geweldige kans!",
  warningModalNoSecondChance: "We geven je geen tweede kans. Deze kans komt niet terug!",
  warningModalGoBack: "Ga Terug",
  warningModalCancel: "Toch Sluiten",
  ...
  telegramLeaksCardDescription: "Ontdek alle exclusieve leaks via Telegram",
  telegramLeaksCardLink: "Bekijk alle sterren →",
  ...
  onlyfansLeaksCardDescription: "Verken alle beschikbare OnlyFans Leaks",
  onlyfansLeaksCardLink: "Bekijk alle sterren →",
  ...
  telegramLeaksViewLink: "Bekijk Telegram Leaks →",
  telegramLeaksAboutTitle: "Over Telegram Leaks",
  telegramLeaksAboutDescription: "Ontdek alle exclusieve Telegram leaks van je favoriete sterren. Onze collectie groepeert alle leaks beschikbaar via Telegram, met gratis toegang en regelmatige content updates.",
  onlyfansLeaksAboutTitle: "Over OnlyFans Leaks",
  onlyfansLeaksAboutDescription: "Verken alle OnlyFans leaks van je favoriete sterren. Onze complete collectie groepeert alle beschikbare leaks, met gratis premium content, exclusieve foto's en video's, dagelijks bijgewerkt.",
