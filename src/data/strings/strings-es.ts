export const strings = {
  ...
  redirectPopupGenderStats: "71% mujeres 29% hombres",
  ...
  // Warning Modal
  warningModalTitle: "⚠️ ¡Espera! Es GRATIS",
  warningModalMessage: "El acceso a los leaks es 100% gratuito. ¡Te estás perdiendo una gran oportunidad!",
  warningModalNoSecondChance: "No te daremos una segunda oportunidad. ¡Esta oportunidad no volverá!",
  warningModalGoBack: "Volver",
  warningModalCancel: "Cerrar de todos modos",
  ...
  telegramLeaksCardTitle: "📱 Leaks Telegram",
  telegramLeaksCardDescription: "Descubre todos los leaks exclusivos vía Telegram",
  telegramLeaksCardLink: "Ver todas las estrellas →",
  ...
  onlyfansLeaksCardTitle: "🔥 Leaks OnlyFans",
  onlyfansLeaksCardDescription: "Explora todos los leaks OnlyFans disponibles",
  onlyfansLeaksCardLink: "Ver todas las estrellas →",
  popularLeaksLink: (name: string) => `Leaks OnlyFans ${name}`,
  viewTelegramLeaks: (name: string) => `Ver los leaks Telegram de ${name}`,
  viewOnlyFansLeaks: (name: string) => `Ver los leaks OnlyFans de ${name}`,
  telegramLeaksLabel: "Leaks Telegram",
  onlyfansLeaksLabel: "Leaks OnlyFans",
  telegramLeaksViewLink: "Ver los leaks Telegram →",
  telegramLeaksAboutTitle: "Acerca de los leaks Telegram",
  telegramLeaksAboutDescription: "Descubre todos los leaks Telegram exclusivos de tus estrellas favoritas. Nuestra colección agrupa todos los leaks disponibles vía Telegram, con acceso gratuito y actualización regular del contenido.",
  onlyfansLeaksAboutTitle: "Acerca de los leaks OnlyFans",
  onlyfansLeaksAboutDescription: "Explora todos los leaks OnlyFans de tus estrellas favoritas. Nuestra colección completa agrupa todos los leaks disponibles, con contenido premium gratuito, fotos y videos exclusivos, actualizados diariamente.",
