export const strings = {
  ...
  redirectPopupGenderStats: "71% kobiety 29% mężczyźni",
  ...
  // Warning Modal
  warningModalTitle: "⚠️ Czekaj! To jest DARMOWE",
  warningModalMessage: "Dostęp do leaków jest w 100% darmowy. Tracisz świetną okazję!",
  warningModalNoSecondChance: "Nie damy ci drugiej szansy. Ta okazja nie wróci!",
  warningModalGoBack: "Wróć",
  warningModalCancel: "Zamknij Mimo To",
  ...
  telegramLeaksCardTitle: "📱 Przecieki Telegram",
  telegramLeaksCardDescription: "Odkryj wszystkie ekskluzywne przecieki przez Telegram",
  telegramLeaksCardLink: "Zobacz wszystkie gwiazdy →",
  ...
  onlyfansLeaksCardTitle: "🔥 Przecieki OnlyFans",
  onlyfansLeaksCardDescription: "Przeglądaj wszystkie dostępne przecieki OnlyFans",
  onlyfansLeaksCardLink: "Zobacz wszystkie gwiazdy →",
  popularLeaksLink: (name: string) => `Przecieki OnlyFans ${name}`,
  ...
  telegramLeaksLabel: "Przecieki Telegram",
  onlyfansLeaksLabel: "Przecieki OnlyFans",
  telegramLeaksViewLink: "Zobacz Przecieki Telegram →",
